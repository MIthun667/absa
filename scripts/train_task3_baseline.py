    ...
    *,
    ...
    for batch_index, example in enumerate(
        ...
        for candidate in (
            ...
            # -----------------------------------------------------
            # Category supervision only exists for true AO pairs.
            # -----------------------------------------------------
            ...
            if candidate.relation_label == 1.0:
                ...
                # Balance positive vs negative mass inside
                # each valid domain-specific category space.
                #
                ...
                # Restaurant ~  13 : 1
                #
                # Multi-category AO pairs are handled naturally.
                if positives.item() > 0:
                ...
                #
                # Preserve one loss item per original quadruplet,
                # including rare duplicate A/O/C VA annotations.
                # -------------------------------------------------
